// https://www.shadertoy.com/view/fd3SDS
...
vec3 nrand3(vec2 co)
{
  ...
  vec3 b=fract(sin(co.x*.3e-3+co.y)*vec3(8.1e5,1.e5,.1e5));
  vec3 c=mix(a,b,.5);
  return c;
}
...
void mainImage(out vec4 fragColor,in vec2 fragCoord){
  ...
  starcolor+=vec4(pow(rnd2.y,100.));
  
  fragColor=mix(freqs[3]-.4,1.,v)*vec4(1.5*freqs[2]*t*t*t,1.2*freqs[1]*t*t,freqs[3]*t,1.)+c2+starcolor;
}
